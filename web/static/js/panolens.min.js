...
function p(a){switch(a.keyCode){case 87:I=!1;break;case 83:J=!1;break;case 65:X=!1;break;case 68:Y=!1}}
function m(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case 87:I=!0;break;case 83:J=!0;break;case 65:X=!0;break;case 68:Y=!0}
...
if(0<=a[c].distance&&a[c].object&&!a[c].object.passThrough&&(!a[c].object.entity||!a[c].object.entity.passThrough)){b=a[c].object.entity&&!a[c].object.entity.passThrough?a[c].object.entity:a[c].object;break}return b},hideInfospot:function(){this.infospot&&(this.infospot.onHoverEnd(),this.infospot=void 0)},toggleControlBar:function(){var a=this.widget;a&&a.dispatchEvent({type:"control-bar-toggle"})},onKeyDown:function(a){this.options.output&&"none"!==this.options.output&&"Control"===a.key&&(this.OUTPUT_INFOSPOT=!0)},onKeyUp:function(){this.OUTPUT_INFOSPOT=!1},update:function(){r.update();this.updateCallbacks.forEach(function(a){a()});if(this.options.controlMode==='edge-hover'){var rect=this.renderer.domElement.getBoundingClientRect();var centerX=rect.left+rect.width/2;var centerY=rect.top+rect.height/2;var normX=(this.edgeHoverMouse.x-centerX)/(rect.width/2);var normY=(this.edgeHoverMouse.y-centerY)/(rect.height/2);normX=Math.max(-1,Math.min(1,normX));normY=Math.max(-1,Math.min(1,normY));if(Math.abs(normX)>0.6||Math.abs(normY)>0.6){var euler=new THREE.Euler().setFromQuaternion(this.camera.quaternion,'YXZ');euler.y+=-normX*this.options.edgeHoverSpeed;euler.x+=-normY*this.options.edgeHoverSpeed;var PI_2=Math.PI/2;euler.x=Math.max(-PI_2,Math.min(PI_2,euler.x));this.camera.quaternion.setFromEuler(euler)}}else if(this.options.controlMode!=='fps'){this.control.update()}
this.scene.traverse(function(a){if(a instanceof z&&a.element&&(this.hoverObject===a||"none"!==a.element.style.display||a.element.left&&"none"!==a.element.left.style.display||a.element.right&&"none"!==a.element.right.style.display))
